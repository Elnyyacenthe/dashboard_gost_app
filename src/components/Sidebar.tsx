...
export default function Sidebar({ onSignOut, open = false, onClose }: SidebarProps) {
  ...
  const mainGroup: NavItem[] = [
    ...
    { to: '/dashboard/wheel',      icon: Disc3,           label: 'Plugbet Wheel', perm: 'nav.games' },
  ...
  const opsGroup: NavItem[] = [
    ...
    { to: '/dashboard/odds',           icon: Radio,         label: 'Ingestion Odds', perm: 'nav.odds' },
    { to: '/dashboard/oddspapi',       icon: PlugZap,       label: 'OddsPapi',       perm: 'nav.oddspapi' },
  ];
